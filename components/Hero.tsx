  ...
  return (
    <div className='h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden pt-36 min-h-fit'>
        ...
        <div className='z-20'>
            ...
            <div className='sm:mt-20 mt-8 space-x-1'>
                <Link href="#about">
                    <button className="sm:heroButton heroButtonSmall">About</button>
                </Link>
                <Link href="#experience">
                    <button className="sm:heroButton heroButtonSmall">Experience</button>
                </Link>
                <Link href="#skills">
                    <button className="sm:heroButton heroButtonSmall">Skills</button>
                </Link>
                <Link href="#projects">
                    <button className="sm:heroButton heroButtonSmall">Projects</button>
                </Link>
            </div>
        </div>
    </div>
